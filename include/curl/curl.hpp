...
namespace curl
{
#ifndef JKSV_CLOUD_VERSION
#define JKSV_CLOUD_VERSION "0.0.0"
#endif

    /// @brief JKSV's user agent string.
    static constexpr const char *STRING_USER_AGENT = "JKSV-Cloud/" JKSV_CLOUD_VERSION;
    ...
    /// @brief Enables certificate and host verification using JKSV's bundled CA certificate store.
    /// @note Call this after reset_handle/prepare_* because those functions reset curl options.
    void enable_tls_verification(curl::Handle &curl);
} // namespace curl
