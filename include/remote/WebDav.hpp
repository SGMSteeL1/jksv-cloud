...
namespace remote
{
    ...
    class WebDav final : public remote::Storage
    {
        public:
            ...
            /// @brief Initializes WebDAV from credentials already acquired by an in-app login flow.
            explicit WebDav(const WebDavConfig &config);

            /// @brief Clears credential copies held by the active WebDAV instance.
            ~WebDav() override;
        ...
        private:
            ...
            /// @brief Enables peer and hostname verification for managed in-app connections.
            bool m_verifyTls{};

            /// @brief Fetches and processes the configured root listing.
            void initialize_listing();
