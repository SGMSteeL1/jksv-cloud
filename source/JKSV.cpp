...
bool JKSV::initialize_sdl()
{
    ...
    bool sdlInit = sdl::initialize("JKSV Cloud", graphics::SCREEN_WIDTH, graphics::SCREEN_HEIGHT);
...
void JKSV::setup_translation_info_strings()
{
    ...
    m_buildString = "v" JKSV_CLOUD_VERSION;
}
...
void JKSV::render_base()
{
    ...
    // Application title displayed next to the header icon.
    static constexpr std::string_view TITLE_TEXT = "JKSV Cloud";
