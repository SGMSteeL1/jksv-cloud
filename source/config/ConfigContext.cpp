...
namespace
{
    constexpr std::string_view PATH_DEFAULT_WORK_DIR = "sdmc:/JKSV Cloud";
    constexpr std::string_view PATH_CONFIG_FOLDER    = "sdmc:/config/JKSV Cloud";
    constexpr std::string_view PATH_CONFIG_FILE      = "sdmc:/config/JKSV Cloud/JKSV.json";
    constexpr std::string_view PATH_PATHS_FILE       = "sdmc:/config/JKSV Cloud/Paths.json";
